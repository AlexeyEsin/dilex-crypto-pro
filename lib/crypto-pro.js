 ...
 */
exports.decryptEnvelopedData = _afterPluginsLoaded_1._afterPluginsLoaded((envelopedData) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
 ...
 */
exports.encryptEnvelopedData = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
