...
const hasPrivateKey_1 = __webpack_require__(/*! ./hasPrivateKey */ "./api/certificate/hasPrivateKey.ts");
class Certificate {
 ...
 */
exports.decryptMessage = _afterPluginsLoaded_1._afterPluginsLoaded((encryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    return eval(_generateCadesFn_1._generateCadesFn(function decryptMessage() {
        let decryptedMessage;
        let cadesRecepients;
        const cadesEnvelopedData = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.CPEnvelopedData');
        try {
            void (_generateCadesFn_1.__cadesAsyncToken__ +
 ...
 */
exports.encryptMessage = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function encryptMessage() {
